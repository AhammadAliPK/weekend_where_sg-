...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies__weekend_where_sg_ui: string;
	export const npm_config_user_agent: string;
	export const npm_package_dependencies__weekend_where_sg_types: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies__weekend_where_sg_ui: string;
		npm_config_user_agent: string;
		npm_package_dependencies__weekend_where_sg_types: string;
